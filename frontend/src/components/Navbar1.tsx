...
const Navbar1 = ({islogin=true}) => {
  ...
  return (
    <div className=" lg:flex bg-dark-background  z-[20] mx-auto  w-full items-center justify-between p-2 border bg-gray-200 ">
      {/* Logo */}
      <div className=' w-full lg:w-auto flex  items-center justify-between lg:justify-start'><div className='flex'><img
      ...
      <div className={`  hidden  lg:flex-row lg:items-center lg:h-12 lg:justify-between lg:flex  transition-all duration-300`}>
        ...
        {/* Goodbye Link */}
        <NavLink className="flex justify-center border  ml-2 mr-2 bg-blue-700  p-2 rounded-md font-serif hover:bg-blue-800 hover:text-white text-lg" to="goodbye">
          <>Goodbye</>
        </NavLink>
